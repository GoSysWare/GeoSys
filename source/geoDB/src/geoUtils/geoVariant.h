...
///		为geoVariant变量申请空间并初始化
 ...
 GEO_UITLS_API geoAPIStatus   GEO_CALL Variant_New(   PIN geoVarTypeEunm nDataType,
...
///两个Variant之间转化
GEO_UITLS_API geoAPIStatus GEO_CALL VariantTypeCast(geoUInt8 DataType, geoVariant* var_src,geoVariant* var_dst );
